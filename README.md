...
A simple simulation used for determining the critical fractional volume of bubbles for percolation to occur in a cosmological phase transition. Details in the thesis this code was used in at [Helda](127.0.0.1).
