...
A simple simulation used for determining the critical fractional volume of bubbles for percolation to occur in a cosmological phase transition. Details in the thesis this code was used in, which can be found in [Helda](127.0.0.1).
...
**!!! Currently this repo is work in progress, the documentation and clean up of the code is incomplete. !!!**
